...
<body class="dark-edition">
  <div class="wrapper ">
    <div class="sidebar" data-color="purple" data-background-color="black" data-image="{{ URL::asset('./assets/img/sidebar-2.jpg')}}">
      <!--
      ...
      <div class="logo">
        ...
        <ul class="nav">
          ...
          <li class="nav-item active">
            <a class="nav-link" href="{{url('almacen/cliente')}}">
              <i class="material-icons">person</i>
              <p>Clientes</p>
            </a>
          </li>
          <li class="nav-item active active">
            <a class="nav-link" href="{{url('almacen/inventario/proveedor-sede')}}">
              <i class="material-icons">content_paste</i>
              <p>Inventarios</p>
            </a>
          </li>
          <li class="nav-item active">
            <a class="nav-link" href="{{URL::action('facturacionListaVentas@show',0)}}">
    ...
    <div class="main-panel">
      ...
      <nav class="navbar navbar-expand-lg navbar-transparent navbar-absolute fixed-top ">
        <div class="container-fluid">
          ...
          <h1 class="text-light">Surtifruver M&M</h1></div>
          </div>
  ...
  <script src="{{ URL::asset('https://unpkg.com/default-passive-events')}}"></script>
  <script src="{{ URL::asset('./assets/js/plugins/perfect-scrollbar.jquery.min.js')}}"></script>
  <!-- Place this tag in your head or just before your close body tag. -->
  <script async defer src="{{ URL::asset('https://buttons.github.io/buttons.js')}}"></script>
